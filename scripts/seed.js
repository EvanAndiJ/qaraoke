// STRAIGHT PAST FROM DASHBOARD. NEEDS ADJUSTMENT
  ...
  try {
    ...
    const insertedUsers = await Promise.all(
      users.map(async (user) => {
        ...
        return client.sql`
        INSERT INTO users (id, username, name, email, password, created, updated)
        VALUES (${user.id}, ${user.username}, ${user.name}, 
          ${user.email}, ${hashedPassword}, ${user.created}, ${user.updated})
